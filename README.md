...
A profanity filter package for Laravel that helps detect and mask profane words in a given sentence. Including substitutions, obscured characters, and doubled letters.

## Installation

I have already install the package via Composer:
